...
<html lang="en" data-bs-theme="dark">
    <head><script src="https://getbootstrap.com/docs/5.3/assets/js/color-modes.js"></script>
        ...
        <style>
            a:hover {
                color: #4a4844; /* Change to your desired hover color */
            }
            ...
            .col-custom-5 {
                flex: 0 0 5%; /* 5% width for the custom column */
                max-width: 5%;
            }
    ...
    <body>
        <%
            ...
            if (genre != null && !genre.isEmpty()) {
                list = memberDAO.getListByGenre(genre);
            } else {
                list = memberDAO.getList(); // Default, unfiltered list
            }
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${list}" var="u">
                        <tr>
                            <td>${u.getSid()}</td>
                            <td>${u.getAuthor()}</td>
                            <td><a href="view.jsp?id=${u.getSid()}" class="link-light link-offset-2 link-underline-opacity-10 link-underline-opacity-100-hover">${u.getTitle()}</a></td>
                            <td>${u.getLocation()}</td>
                            <td><a href="view.jsp?id=${u.getSid()}" class="link-light link-offset-2 link-underline-opacity-10 link-underline-opacity-100-hover">${u.getContent()}</a></td>
                            <td>${u.getGenre()}</td>
                            <td>${u.getRegdate()}</td>
