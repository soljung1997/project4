...
<main class="container mt-5">
    ...
    <article class="blog-post">
        <div class="blog-header">
            <h2 class="display-4"><%= u.getTitle() %></h2>
            <hr class="blog-divider-2">
        </div>
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="lead genre">Genre: <%= u.getGenre() %></h1>
                </div>
                <div class="col-md-6 text-right">
                    <p class="right-aligned-text">Author: <%= u.getAuthor() %></p>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p class="right-aligned-text">Date: <%= u.getRegdate() %></p>
                </div>
            </div>
        ...
        <div class="blog-post-content">
            ...
            <hr class="blog-divider">
            <p class="content"><%= u.getContent() %></p>
        </div>
    </article>
</main>
